...
function fitSelection(value, selectionSVGPointX, selectionSVGPointY, selectionWidth, selectionHeight) {
  var SVGAlignX = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : _constants.ALIGN_LEFT;
  var SVGAlignY = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : _constants.ALIGN_TOP;
  var viewerWidth = value.viewerWidth,
    viewerHeight = value.viewerHeight;
